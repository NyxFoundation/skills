...
metadata:
  hermes:
    ...
    related_skills: [pdf, xlsx, powerpoint, ocr-and-documents, docx-proposal-filler]
---
...
`pdf` (PDF work), `xlsx` (spreadsheets), `powerpoint` (decks), `ocr-and-documents` (scanned input extraction), `docx-proposal-filler` (filling Japanese government/grant form templates without breaking their tables).
