...
**「40 分 ÷ 5 名 ＝ 1 人 8 分」は間違い。**冒頭・紹介・会場質疑・締めを引き忘れている。
実際に質問に使えるのは、40 分なら 22 分前後。**モデレーターを含めて 5 名なら、
質問を受けるのは 4 名で、1 人あたり 5 分半**が現実の数字。

**共通質問は成立しない。**第 2・第 3 ラウンドを作らず、
**1 人 1 問、その人にしか答えられないもの**を用意する。追い質問は 1 回まで。
2 回目を入れると必ず溢れる。

**この割り算の間違いは、台本のヘッダと本文の食い違いとして残る。**
本文を各 5.5 分に直したのに、ヘッダの「1 人 8 分」を消し忘れて指摘された。
**進行担当が 8 分枠で回すと、質疑と締めが崩れる。**
